...
- Configure ``ablestar-cli`` with your credentials
...
.. toctree::
   installation
   creating_shopify_api_credentials
   basic_usage
...
.. raw:: html
    ...
    <script async id="asciicast-589699" src="https://asciinema.org/a/589699.js"></script>

This will produce an Excel file that looks like this:

.. image:: images/shopify-order-export.png
  :width: 1258
